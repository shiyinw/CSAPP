 ...
 * 
 * I first implemented the model on book (mm_init, mm_malloc, mm_free, extend_heap ......)
 * Then I apply a hash table to maintain all the spaces. I store pointers in the content part.
 * Hash Key = log (size)
 * 
 */
#include <stdio.h>
